...
#write the output file to a wave file for verification
wf1 = wave.open('direct_form_output.wav', 'w')
wf1.setnchannels(num_channels)
...
while len(input_string) > 0:
    ...
    # Write the binary string to a wave file
