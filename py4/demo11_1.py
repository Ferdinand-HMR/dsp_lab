...
output_block1 = [0 for n in range(0, BLOCKSIZE)]
...
for i in range(0, num_blocks):
    ...
    for n in range(0, BLOCKSIZE):
        ...
        theta1 = theta1 + om1
        output_block1[n] = int( input_tuple[n] * math.cos(theta1))
    ...
    output_string += struct.pack('h' * BLOCKSIZE, *output_block1)
    # output_string = struct.pack('i' * BLOCKSIZE, *output_block1)
